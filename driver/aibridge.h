...
// ---------------------------------------------------------------------------
#define IOCTL_AI_READ_PROCESS_MEMORY  CTL_CODE(FILE_DEVICE_AIBRIDGE, 0x800, METHOD_BUFFERED, FILE_READ_DATA)
#define IOCTL_AI_LIST_PROCESSES       CTL_CODE(FILE_DEVICE_AIBRIDGE, 0x801, METHOD_BUFFERED, FILE_READ_DATA)
#define IOCTL_AI_KILL_PROCESS         CTL_CODE(FILE_DEVICE_AIBRIDGE, 0x802, METHOD_BUFFERED, FILE_WRITE_DATA)
#define IOCTL_AI_READ_REGISTRY        CTL_CODE(FILE_DEVICE_AIBRIDGE, 0x803, METHOD_BUFFERED, FILE_READ_DATA)
#define IOCTL_AI_WRITE_REGISTRY       CTL_CODE(FILE_DEVICE_AIBRIDGE, 0x804, METHOD_BUFFERED, FILE_WRITE_DATA)
#define IOCTL_AI_LIST_FILES           CTL_CODE(FILE_DEVICE_AIBRIDGE, 0x805, METHOD_BUFFERED, FILE_READ_DATA)
#define IOCTL_AI_READ_FILE            CTL_CODE(FILE_DEVICE_AIBRIDGE, 0x806, METHOD_BUFFERED, FILE_READ_DATA)
#define IOCTL_AI_WRITE_FILE           CTL_CODE(FILE_DEVICE_AIBRIDGE, 0x807, METHOD_BUFFERED, FILE_WRITE_DATA)
